...
namespace PragmaRX\Google2FAPhp;
...
use Base32\Base32;
use PragmaRX\Google2FAPhp\Contracts\Google2FAPhp as Google2FAContract;
use PragmaRX\Google2FAPhp\Exceptions\InvalidCharactersException;
use PragmaRX\Google2FAPhp\Exceptions\SecretKeyTooShortException;
use PragmaRX\Google2FAPhp\Support\Url;

class Google2FAPhp implements Google2FAContract
{
    /**

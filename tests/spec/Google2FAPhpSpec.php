...
namespace spec\PragmaRX\Google2FAPhp;

use PhpSpec\ObjectBehavior;
use PragmaRX\Google2FAPhp\Google2FAPhp;

class Google2FAPhpSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('PragmaRX\Google2FAPhp\Google2FAPhp');
    }
    ...
    public function it_generates_a_valid_secret_key()
    {
        ...
        $this->generateSecretKey()->shouldBeAmongst(Google2FAPhp::VALID_FOR_B32);
    }
